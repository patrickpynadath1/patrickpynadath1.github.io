...
The arXiv version of this blog is available at [this link](https://arxiv.org/abs/2604.02718).

<TableOfContents 
  client:load
  sections={[
    "Dataset Choice: Why OpenWebText is the Standard",
    "LM1B is Shuffled at Sentence Level",
...
<br />
```bibtex
@misc{pynadath2026generativefrontiersevaluationmatters,
      title={Generative Frontiers: Why Evaluation Matters for Diffusion Language Models}, 
      ...
      archivePrefix={arXiv},
      primaryClass={cs.LG},
      url={https://arxiv.org/abs/2604.02718}, 
}
```
